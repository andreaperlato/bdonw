...
See here below a quick remind of the rectifier function.
...
A quick refresher about **Activation Function**. </br>
We have four different types of activation functions that we can choose from.
