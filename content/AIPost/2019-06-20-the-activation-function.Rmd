...
The [**Rectifier Function**](https://en.wikipedia.org/wiki/Activation_function) is one of the most popular functions for artificial neural networks so when its goes all the way to zero it is zero, and from there it is fradually progresses as the input value increase as well. 

<center>
![](/img/rectifierfunction.png){width=40%}
</center>

The [**Hyperbolic Tangent tanh Function**](https://en.wikipedia.org/wiki/Activation_function) is very similar to the sigmoid function, but here the hyperbolic tangent function goes below zero, and that could be useful in some application such as 
