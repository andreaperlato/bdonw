...
Now the results from the two labs are comparable. We can clearly see that for the vast majority of natural elements the Italian lab give a more severe result as opposed to the Swiss Lab. The massive deficiency of natual elements highlighted in Italy is contradicted by the analyses made in Switzerland.
