...
We have the density function of miles per gallon (mpg). Cylindres is a categorical variable and so is represented by an histogram. Cylondres vs. mpg gives us the fuel consumption per number of cylindres using the box-plot representation. And in the cases where we have both variables continues the graph give back upper the correlation level and lower the graph of the relationship (e.g. displacement vs. mpg).
