...
```
The model **mod_gam3** uses the [**tensor**](https://www.youtube.com/watch?v=CliW7kSxxWU) smooth for predictors. If we look at the concurvity, in the worst case scenario **Grazing.Footprint** and **Forest.Land** have a strog relationship, but looking at the observed estimation the correlation is not very strong.
