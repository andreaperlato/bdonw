...
The graph above represent all the users in the test set characterized by their age and Salary. Red points are user that did not buy the new product and the greed point are those who bought it. Most of the users who are older and with high salary bought the products, but also some aged people with low salary bought the product (probably they saved some money and they couldn’t resist to this very cool luxury product). 
The prediction regions are linearly separated accordingly with the logistic regression. The prediction boundary is a straight line, in fact the logistic regression classifier is a linear classifier. 
